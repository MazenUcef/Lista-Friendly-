...
const DashboardLayOut = () => {
    const [active, setActive] = useState<"Dashboard" | "Profile" | "Create Brand" | "Favorites" | "Users" | "Brands">("Profile")
            ...
            <aside ref={sidebarRef}
                ...
                <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                    <ul className="space-y-3 font-medium">
                        ...
                        <li>
                            <Link to="create-brand" onClick={() => setActive("Create Brand")} className={`${active === "Create Brand" && "bg-gray-200"} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group`}>
                                <PlusSquare color="#73bf63" size={25} />
                                <span className="flex-1 ms-3 whitespace-nowrap">Create Brand</span>
                            </Link>
                        </li>
                        <li>
                            <Link to="favorites" onClick={() => setActive("Favorites")} className={`${active === "Favorites" && "bg-gray-200"} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group`}>
