...
const DashboardLayOut = () => {
    const [active, setActive] = useState<"Dashboard" | "Profile" | "Create Brand" | "Favorites" | "Users" | "Brands">("Dashboard")
                    ...
                    <ul className="space-y-2 font-medium">
                        <li>
                            <Link to="manage" onClick={() => setActive("Dashboard")} className={`${active === "Dashboard" && "bg-gray-200"} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group`}>
                                ...
                                <span className="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-[#71BE63] bg-[#c2ecbb] rounded-full dark:bg-gray-700 dark:text-gray-300">Admin</span>
                            </Link>
                        </li>
                        <li>
                            <Link to="profile" onClick={() => setActive("Profile")} className={`${active === "Profile" && "bg-gray-200"} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group`}>
                                <User color="#73bf63" size={25} />
                                <span className="flex-1 ms-3 whitespace-nowrap">Profile</span>
                            </Link>
                        </li>
                        <li>
                            <Link to="#" onClick={() => setActive("Create Brand")} className={`${active === "Create Brand" && "bg-gray-200"} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group`}>
                                <PlusSquare color="#73bf63" size={25} />
                                <span className="flex-1 ms-3 whitespace-nowrap">Create Brand</span>
                            </Link>
                        </li>
                        <li>
                            <Link to="#" onClick={() => setActive("Favorites")} className={`${active === "Favorites" && "bg-gray-200"} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group`}>
                                <FaHeart color="#73bf63" size={25} />
                                <span className="flex-1 ms-3 whitespace-nowrap">Favorites</span>
                                <span className="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-[#71BE63] bg-[#c2ecbb] rounded-full dark:bg-blue-900 dark:text-blue-300">3</span>
                            </Link>
                        </li>
                        <li>
                            <Link to="#" onClick={() => setActive("Users")} className={`${active === "Users" && "bg-gray-200"} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group`}>
                        ...
                        <li>
                            <Link to="#" onClick={() => setActive("Brands")} className={`${active === "Brands" && "bg-gray-200"} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group`}>
